      ...
      <main>
        <div className="relative pt-16 pb-32 flex content-center items-center justify-center min-h-screen-75">
          <div
            ...
            style={{
              backgroundImage: `url(${require("assets/img/contact/Contact.jpg").default})`,
            }}
          >
            <span
              id="blackOverlay"
       ...
       {/* <section className="relative py-20">
        ...
        <section className="pb-20 relative block ">
          ...
          <div className="container mx-auto px-4 ">
          <div className="flex flex-wrap mt-40 lg:mt-64 justify-center">

              <div className="w-full lg:w-6/12 px-4 lg:ml-16 ">
          ...
          <div className="container mx-auto px-4 lg:pt-16 lg:pb-64">
            <div className="flex flex-wrap text-center justify-center">
              <div className="w-full lg:w-6/12 px-4">
                <h2 className="text-xxl font-semibold text-white uppercase">
                  Get in touch
                </h2>
                <p className="text-lg leading-relaxed mt-4 mb-4 text-white">
                 we’re here to help you stay fit and strong!
                </p>
              </div>
            </div>
            <div className="flex flex-wrap mt-12 justify-center">
              <div className="w-full lg:w-3/12 px-4 text-center">
                <div className="text-blueGray-800 p-3 w-12 h-12 shadow-lg rounded-full bg-grey inline-flex items-center justify-center">
